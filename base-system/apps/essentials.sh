...
alps selfupdate
alps updatescripts
su $USERNAME -c "PKG_BUILDER=$1 alps install --options nr --packages nano openssl10 general_which wget cacerts python2 python3 ntfs-3g fuse lvm2 parted gptfdisk shadow"
