...
alps selfupdate
alps updatescripts
su - $USERNAME -c "PKG_BUILDER=$1 alps install -ni profile python2 python3 nano openssl10 general_which wget make-ca ntfs-3g fuse lvm2 parted gptfdisk shadow"
