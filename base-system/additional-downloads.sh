...
wget -nc https://bitbucket.org/chandrakantsingh/patches/raw/$VERSION/aufs-4.20.tar.gz
...
wget -nc https://bitbucket.org/chandrakantsingh/patches/raw/$VERSION/aufs4-z.patch
