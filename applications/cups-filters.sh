...
NAME=cups-filters
VERSION=1.28.15
URL=https://www.openprinting.org/download/cups-filters/cups-filters-1.28.15.tar.xz
SECTION="Printing"
...
wget -nc https://www.openprinting.org/download/cups-filters/cups-filters-1.28.15.tar.xz
...
./configure --prefix=/usr        \
            ...
            --disable-static     \
            --disable-avahi      \
            --docdir=/usr/share/doc/cups-filters-1.28.15 &&
make
