...
wget -nc https://download.gnome.org/sources/gnome-shell/42/gnome-shell-42.2.tar.xz
wget -nc ftp://ftp.acc.umu.se/pub/gnome/sources/gnome-shell/42/gnome-shell-42.2.tar.xz
