...
NAME=graphviz
VERSION=3.0.0
URL=https://gitlab.com/graphviz/graphviz/-/archive/3.0.0/graphviz-3.0.0.tar.bz2
...
wget -nc https://gitlab.com/graphviz/graphviz/-/archive/3.0.0/graphviz-3.0.0.tar.bz2
...
sudo rm -rf /tmp/rootscript.sh
cat > /tmp/rootscript.sh <<"ENDOFROOTSCRIPT"
ln -svr /usr/share/graphviz/doc /usr/share/doc/graphviz-3.0.0
ENDOFROOTSCRIPT
