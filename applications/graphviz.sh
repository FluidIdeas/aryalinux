...
NAME=graphviz
VERSION=4.0.0
URL=https://gitlab.com/graphviz/graphviz/-/archive/4.0.0/graphviz-4.0.0.tar.bz2
...
wget -nc https://gitlab.com/graphviz/graphviz/-/archive/4.0.0/graphviz-4.0.0.tar.bz2
...
./configure --prefix=/usr \
            --disable-php \
            --docdir=/usr/share/doc/graphviz-4.0.0 &&
