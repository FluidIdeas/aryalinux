...
NAME=libcap
VERSION=2.64
URL=https://www.kernel.org/pub/linux/libs/security/linux-privs/libcap2/libcap-2.64.tar.xz
SECTION="Security"
...
wget -nc https://www.kernel.org/pub/linux/libs/security/linux-privs/libcap2/libcap-2.64.tar.xz
