...
wget -nc https://www.kernel.org/pub/linux/libs/security/linux-privs/libcap2/libcap-2.33.tar.xz


NAME=libcap
VERSION=2.33
URL=https://www.kernel.org/pub/linux/libs/security/linux-privs/libcap2/libcap-2.33.tar.xz
SECTION="Security"
