...
wget -nc https://download.gnome.org/sources/gnumeric/1.12/gnumeric-1.12.52.tar.xz
wget -nc ftp://ftp.acc.umu.se/pub/gnome/sources/gnumeric/1.12/gnumeric-1.12.52.tar.xz
