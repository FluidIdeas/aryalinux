...
NAME=clutter
VERSION=1.26.4
URL=https://mirror.umd.edu/gnome/sources/clutter/1.26/clutter-1.26.4.tar.xz
SECTION="X Libraries"
...
wget -nc https://mirror.umd.edu/gnome/sources/clutter/1.26/clutter-1.26.4.tar.xz
