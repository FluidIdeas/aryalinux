...
wget -nc https://download.gnome.org/sources/goffice/0.10/goffice-0.10.48.tar.xz
wget -nc ftp://ftp.acc.umu.se/pub/gnome/sources/goffice/0.10/goffice-0.10.48.tar.xz
