...
NAME=goffice010
VERSION=0.10.49
URL=https://mirror.umd.edu/gnome/sources/goffice/0.10/goffice-0.10.49.tar.xz
SECTION="X Libraries"
...
wget -nc https://mirror.umd.edu/gnome/sources/goffice/0.10/goffice-0.10.49.tar.xz
