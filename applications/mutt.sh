...
wget -nc https://bitbucket.org/mutt/mutt/downloads/mutt-2.1.3.tar.gz
wget -nc ftp://ftp.mutt.org/pub/mutt/mutt-2.1.3.tar.gz
...
./configure --prefix=/usr                           \
            --sysconfdir=/etc                       \
            --with-docdir=/usr/share/doc/mutt-2.1.3 \
            --with-ssl                              \
...
cat /usr/share/doc/mutt-2.1.3/samples/gpg.rc >> ~/.muttrc
