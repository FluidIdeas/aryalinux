...
wget -nc https://bitbucket.org/mutt/mutt/downloads/mutt-2.2.0.tar.gz
wget -nc ftp://ftp.mutt.org/pub/mutt/mutt-2.2.0.tar.gz
...
./configure --prefix=/usr                           \
            --sysconfdir=/etc                       \
            --with-docdir=/usr/share/doc/mutt-2.2.0 \
            --with-ssl                              \
...
cat /usr/share/doc/mutt-2.2.0/samples/gpg.rc >> ~/.muttrc
