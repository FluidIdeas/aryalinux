...
VERSION=3.12.0
URL=https://mirror.umd.edu/gnome/sources/gnome-icon-theme-extras/3.12/gnome-icon-theme-extras-3.12.0.tar.xz
SECTION="Icons"
...
wget -nc https://mirror.umd.edu/gnome/sources/gnome-icon-theme-extras/3.12/gnome-icon-theme-extras-3.12.0.tar.xz
