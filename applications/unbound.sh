...
wget -nc http://www.unbound.net/downloads/unbound-1.9.4.tar.gz


NAME=unbound
VERSION=1.9.4
URL=http://www.unbound.net/downloads/unbound-1.9.4.tar.gz
...
sudo rm -rf /tmp/rootscript.sh
cat > /tmp/rootscript.sh <<"ENDOFROOTSCRIPT"
install -v -m755 -d /usr/share/doc/unbound-1.9.4 &&
install -v -m644 doc/html/* /usr/share/doc/unbound-1.9.4
ENDOFROOTSCRIPT
