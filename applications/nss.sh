...
NAME=nss
VERSION=3.73
URL=https://archive.mozilla.org/pub/security/nss/releases/NSS_3_73_RTM/src/nss-3.73.tar.gz
SECTION="Security"
...
wget -nc https://archive.mozilla.org/pub/security/nss/releases/NSS_3_73_RTM/src/nss-3.73.tar.gz
wget -nc https://bitbucket.org/chandrakantsingh/patches/raw/4.0/nss-3.73-standalone-1.patch
