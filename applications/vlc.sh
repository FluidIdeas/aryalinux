...
NAME=vlc
VERSION=3.0.17.3
URL=https://download.videolan.org/vlc/3.0.17.3/vlc-3.0.17.3.tar.xz
...
wget -nc https://download.videolan.org/vlc/3.0.17.3/vlc-3.0.17.3.tar.xz
...
make docdir=/usr/share/doc/vlc-3.0.17.3 install
ENDOFROOTSCRIPT
