...
if [ ! -z $URL ]
then
wget -nc https://www.gnupg.org/ftp/gcrypt/npth/npth-1.6.tar.bz2 || wget -nc http://mirrors-usa.go-parts.com/blfs/conglomeration/npth/npth-1.6.tar.bz2 || wget -nc http://mirrors-ru.go-parts.com/blfs/conglomeration/npth/npth-1.6.tar.bz2 || wget -nc ftp://ftp.lfs-matrix.net/pub/blfs/conglomeration/npth/npth-1.6.tar.bz2 || wget -nc http://ftp.lfs-matrix.net/pub/blfs/conglomeration/npth/npth-1.6.tar.bz2 || wget -nc ftp://ftp.osuosl.org/pub/blfs/conglomeration/npth/npth-1.6.tar.bz2 || wget -nc http://ftp.osuosl.org/pub/blfs/conglomeration/npth/npth-1.6.tar.bz2
