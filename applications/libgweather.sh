...
wget -nc https://download.gnome.org/sources/libgweather/4.0/libgweather-4.0.0.tar.xz
wget -nc ftp://ftp.acc.umu.se/pub/gnome/sources/libgweather/4.0/libgweather-4.0.0.tar.xz
