...
wget -nc http://www.php.net/distributions/php-7.3.12.tar.xz
...
NAME=php
VERSION=7.3.12
URL=http://www.php.net/distributions/php-7.3.12.tar.xz
...
install -v -m755 -d /usr/share/doc/php-7.3.12 &&
install -v -m644    CODING_STANDARDS EXTENSIONS INSTALL NEWS README* UPGRADING* php.gif \
                    /usr/share/doc/php-7.3.12 &&
