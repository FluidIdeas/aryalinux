...
wget -nc https://download.gnome.org/sources/gtksourceview/5.6/gtksourceview-5.6.2.tar.xz
wget -nc ftp://ftp.acc.umu.se/pub/gnome/sources/gtksourceview/5.6/gtksourceview-5.6.2.tar.xz
