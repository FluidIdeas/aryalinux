...
wget -nc http://download.kde.org/stable/release-service/19.12.2/src/k3b-19.12.2.tar.xz


NAME=k3b
VERSION=19.12.2
URL=http://download.kde.org/stable/release-service/19.12.2/src/k3b-19.12.2.tar.xz
