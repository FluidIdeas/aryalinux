...
<code class="literal"><?xml version='1.0'?> <!DOCTYPE fontconfig SYSTEM 'fonts.dtd'> <fontconfig> <dir>/opt/texlive/2018/texmf-dist/fonts/opentype/arkandis/berenisadf</dir> <dir>/opt/texlive/2018/texmf-dist/fonts/truetype/paratype</dir> </fontconfig></code>
EOF
EOF
chmod a+x /tmp/rootscript.sh
sudo /tmp/rootscript.sh
