...
wget -nc http://ftp.gnome.org/pub/gnome/sources/gnome-calculator/3.36/gnome-calculator-3.36.0.tar.xz


NAME=gnome-calculator
VERSION=3.36.0
URL=http://ftp.gnome.org/pub/gnome/sources/gnome-calculator/3.36/gnome-calculator-3.36.0.tar.xz
