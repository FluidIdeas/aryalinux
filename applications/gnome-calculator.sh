...
wget -nc https://download.gnome.org/sources/gnome-calculator/42/gnome-calculator-42.1.tar.xz
wget -nc ftp://ftp.acc.umu.se/pub/gnome/sources/gnome-calculator/42/gnome-calculator-42.1.tar.xz
