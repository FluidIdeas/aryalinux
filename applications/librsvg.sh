...
wget -nc https://download.gnome.org/sources/librsvg/2.54/librsvg-2.54.4.tar.xz
wget -nc ftp://ftp.acc.umu.se/pub/gnome/sources/librsvg/2.54/librsvg-2.54.4.tar.xz
