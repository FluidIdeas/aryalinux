...
wget -nc https://download.gnome.org/sources/librsvg/2.52/librsvg-2.52.5.tar.xz
wget -nc ftp://ftp.acc.umu.se/pub/gnome/sources/librsvg/2.52/librsvg-2.52.5.tar.xz
...
./configure --prefix=/usr    \
            --enable-vala    \
            --disable-static \
            --docdir=/usr/share/doc/librsvg-2.52.5 &&
make
