...
NAME=glib2
VERSION=2.60.5
URL=http://ftp.gnome.org/pub/gnome/sources/glib/2.60/glib-2.60.5.tar.xz
...
patch -Np1 -i ../glib-2.60.5-skip_warnings-1.patch
mkdir build &&
cd    build &&
...
mkdir -p /usr/share/doc/glib-2.60.5 &&
cp -r ../docs/reference/{NEWS,gio,glib,gobject} /usr/share/doc/glib-2.60.5
ENDOFROOTSCRIPT
