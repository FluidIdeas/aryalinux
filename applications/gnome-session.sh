...
wget -nc https://download.gnome.org/sources/gnome-session/42/gnome-session-42.0.tar.xz
wget -nc ftp://ftp.acc.umu.se/pub/gnome/sources/gnome-session/42/gnome-session-42.0.tar.xz
