...
wget -nc http://llvm.org/releases/7.0.0/llvm-7.0.0.src.tar.xz
...
install -v -d -m755 /usr/share/doc/llvm-7.0.0/llvm-html     &&
cp -Rv docs/html/* /usr/share/doc/llvm-7.0.0/llvm-html
EOF
chmod a+x /tmp/rootscript.sh
sudo /tmp/rootscript.sh
sudo rm /tmp/rootscript.sh
...
install -v -d -m755 /usr/share/doc/llvm-7.0.0/clang-html    &&
cp -Rv tools/clang/docs/html/* /usr/share/doc/llvm-7.0.0/clang-html
EOF
chmod a+x /tmp/rootscript.sh
sudo /tmp/rootscript.sh
sudo rm /tmp/rootscript.sh
