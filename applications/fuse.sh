...
wget -nc https://github.com/libfuse/libfuse/releases/download/fuse-3.7.0/fuse-3.7.0.tar.xz


NAME=fuse
VERSION=3.7.0
URL=https://github.com/libfuse/libfuse/releases/download/fuse-3.7.0/fuse-3.7.0.tar.xz
