...
VERSION=9.1.0
URL=https://files.pythonhosted.org/packages/source/s/sphinx/sphinx-9.1.0.tar.gz
SECTION="Others"
...
wget -nc https://files.pythonhosted.org/packages/source/s/sphinx/sphinx-9.1.0.tar.gz
