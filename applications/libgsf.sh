...
wget -nc https://download.gnome.org/sources/libgsf/1.14/libgsf-1.14.49.tar.xz
wget -nc ftp://ftp.acc.umu.se/pub/gnome/sources/libgsf/1.14/libgsf-1.14.49.tar.xz
