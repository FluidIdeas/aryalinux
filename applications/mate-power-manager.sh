...
VERSION=1.26.0
URL=https://pub.mate-desktop.org/releases/1.26/mate-power-manager-1.26.0.tar.xz
...
wget -nc https://pub.mate-desktop.org/releases/1.26/mate-power-manager-1.26.0.tar.xz
