...
wget -nc https://pub.mate-desktop.org/releases/1.25/mate-power-manager-1.25.0.tar.xz


NAME=mate-power-manager
VERSION=1.25.0
URL=https://pub.mate-desktop.org/releases/1.25/mate-power-manager-1.25.0.tar.xz
