...
wget -nc https://pub.mate-desktop.org/releases/1.24/mate-power-manager-1.24.0.tar.xz


NAME=mate-power-manager
VERSION=1.24.0
URL=https://pub.mate-desktop.org/releases/1.24/mate-power-manager-1.24.0.tar.xz
