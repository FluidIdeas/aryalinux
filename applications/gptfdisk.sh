...
wget -nc https://downloads.sourceforge.net/gptfdisk/gptfdisk-1.0.5.tar.gz
wget -nc https://bitbucket.org/chandrakantsingh/patches/raw/2.4/gptfdisk-1.0.5-convenience-1.patch
