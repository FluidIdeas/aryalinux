...
VERSION=3.2.2
URL=https://download.gnome.org/sources/tracker-miners/3.2/tracker-miners-3.2.2.tar.xz
...
wget -nc https://download.gnome.org/sources/tracker-miners/3.2/tracker-miners-3.2.2.tar.xz
wget -nc ftp://ftp.acc.umu.se/pub/gnome/sources/tracker-miners/3.2/tracker-miners-3.2.2.tar.xz
