...
wget -nc https://bitbucket.org/chandrakantsingh/patches/raw/5.0/polkit-0.120-security_fixes-1.patch
wget -nc https://bitbucket.org/chandrakantsingh/patches/raw/5.0/polkit-0.120-js91-1.patch
