...
wget -nc https://github.com/PipeWire/pipewire/archive/0.3.24/pipewire-0.3.24.tar.gz


NAME=pipewire
VERSION=0.3.24
URL=https://github.com/PipeWire/pipewire/archive/0.3.24/pipewire-0.3.24.tar.gz
