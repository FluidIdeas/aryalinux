...
NAME=pipewire
VERSION=0.3.40
URL=https://github.com/PipeWire/pipewire/archive/0.3.40/pipewire-0.3.40.tar.gz
...
wget -nc https://github.com/PipeWire/pipewire/archive/0.3.40/pipewire-0.3.40.tar.gz
