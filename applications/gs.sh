...
wget -nc https://bitbucket.org/chandrakantsingh/patches/raw/2.0/ghostscript-9.27-upstream_fixes-2.patch
...
patch -Np1 -i ../ghostscript-9.27-upstream_fixes-2.patch &&
