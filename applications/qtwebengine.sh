...
wget -nc https://bitbucket.org/chandrakantsingh/patches/raw/4.0/qtwebengine-20210401-build_fixes-1.patch
...
patch -Np1 -i ../qtwebengine-20210401-build_fixes-1.patch
