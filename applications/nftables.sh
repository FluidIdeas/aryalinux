...
SECTION="Security"
DESCRIPTION="The nftables package, intended to be the successor to iptables-1.8.4, provides a low-level netlink programming interface (API), and userspace uitlities for the in-kernel nf_tables subsystem."
