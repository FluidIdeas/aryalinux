...
wget -nc https://download.gnome.org/sources/yelp-xsl/42/yelp-xsl-42.0.tar.xz
wget -nc ftp://ftp.acc.umu.se/pub/gnome/sources/yelp-xsl/42/yelp-xsl-42.0.tar.xz
