...
wget -nc https://ftp.gnu.org/gnu/libidn/libidn-1.40.tar.gz
wget -nc ftp://ftp.gnu.org/gnu/libidn/libidn-1.40.tar.gz
...
mkdir -v       /usr/share/doc/libidn-1.40     &&
cp -r -v doc/* /usr/share/doc/libidn-1.40
ENDOFROOTSCRIPT
