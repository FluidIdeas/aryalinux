...
wget -nc https://github.com/webmproject/libvpx/archive/v1.8.2/libvpx-1.8.2.tar.gz


NAME=libvpx
VERSION=1.8.2
URL=https://github.com/webmproject/libvpx/archive/v1.8.2/libvpx-1.8.2.tar.gz
