...
wget -nc https://curl.haxx.se/download/curl-7.69.0.tar.xz


NAME=curl
VERSION=7.69.0
URL=https://curl.haxx.se/download/curl-7.69.0.tar.xz
...
install -v -d -m755 /usr/share/doc/curl-7.69.0 &&
cp -v -R docs/*     /usr/share/doc/curl-7.69.0
ENDOFROOTSCRIPT
