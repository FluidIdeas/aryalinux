...
NAME=curl
VERSION=7.82.0
URL=https://curl.se/download/curl-7.82.0.tar.xz
...
wget -nc https://curl.se/download/curl-7.82.0.tar.xz
...
install -v -d -m755 /usr/share/doc/curl-7.82.0 &&
cp -v -R docs/*     /usr/share/doc/curl-7.82.0
ENDOFROOTSCRIPT
