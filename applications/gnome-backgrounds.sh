...
wget -nc https://download.gnome.org/sources/gnome-backgrounds/42/gnome-backgrounds-42.0.tar.xz
wget -nc ftp://ftp.acc.umu.se/pub/gnome/sources/gnome-backgrounds/42/gnome-backgrounds-42.0.tar.xz
