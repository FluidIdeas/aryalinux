...
VERSION=40.1
URL=https://mirror.umd.edu/gnome/sources/gnome-backgrounds/40/gnome-backgrounds-40.1.tar.xz
...
wget -nc https://mirror.umd.edu/gnome/sources/gnome-backgrounds/40/gnome-backgrounds-40.1.tar.xz
