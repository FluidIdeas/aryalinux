...
wget -nc http://ftp.gnome.org/pub/gnome/sources/gnome-backgrounds/3.36/gnome-backgrounds-3.36.0.tar.xz


NAME=gnome-backgrounds
VERSION=3.36.0
URL=http://ftp.gnome.org/pub/gnome/sources/gnome-backgrounds/3.36/gnome-backgrounds-3.36.0.tar.xz
