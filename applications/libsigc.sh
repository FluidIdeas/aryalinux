...
wget -nc https://download.gnome.org/sources/libsigc++/2.10/libsigc++-2.10.8.tar.xz
wget -nc ftp://ftp.acc.umu.se/pub/gnome/sources/libsigc++/2.10/libsigc++-2.10.8.tar.xz
