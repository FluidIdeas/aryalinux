...
NAME=xine-lib
VERSION=1.2.12
URL=https://downloads.sourceforge.net/xine/xine-lib-1.2.12.tar.xz
...
wget -nc https://downloads.sourceforge.net/xine/xine-lib-1.2.12.tar.xz
wget -nc ftp://ftp.mirrorservice.org/sites/distfiles.gentoo.org/distfiles/xine-lib-1.2.12.tar.xz
