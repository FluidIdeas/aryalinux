...
NAME=asciidoctor
VERSION=2.0.16
URL=https://github.com/asciidoctor/asciidoctor/archive/v2.0.16/asciidoctor-2.0.16.tar.gz
...
wget -nc https://github.com/asciidoctor/asciidoctor/archive/v2.0.16/asciidoctor-2.0.16.tar.gz
