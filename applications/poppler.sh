...
wget -nc https://poppler.freedesktop.org/poppler-23.04.0.tar.xz
...
sudo rm -rf /tmp/rootscript.sh
cat > /tmp/rootscript.sh <<"ENDOFROOTSCRIPT"
install -v -m755 -d           /usr/share/doc/poppler-23.04.0 &&
cp -vr ../glib/reference/html /usr/share/doc/poppler-23.04.0
ENDOFROOTSCRIPT
