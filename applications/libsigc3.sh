...
wget -nc https://download.gnome.org/sources/libsigc++/3.0/libsigc++-3.0.7.tar.xz
wget -nc ftp://ftp.acc.umu.se/pub/gnome/sources/libsigc++/3.0/libsigc++-3.0.7.tar.xz
